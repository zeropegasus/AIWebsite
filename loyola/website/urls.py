...
urlpatterns = [
    ...
    path('workshop', TemplateView.as_view(template_name='workshoplist.html')),
    ...
    path('lab', views.lab_list_view, name='lab_list_view'),
    path('lab/<int:order>', views.lab_detail_view, name='lab_detail_view'),
