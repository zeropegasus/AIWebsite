...
class Program(models.Model):
    ...
    image = models.ImageField(upload_to='website/static/img/program/')
...
class Module(models.Model):
    ...
    description = models.TextField(null=True, blank=True)
    duration = models.IntegerField(null=True, blank=True)
    image = models.ImageField(upload_to='website/static/img/module/')
    category = models.CharField(max_length=255, null=True, blank=True)
    is_published = models.BooleanField(null=True, blank=True)
...
class Workshop(models.Model):
    ...
    description = models.TextField(null=True, blank=True)
    duration = models.IntegerField(null=True, blank=True)
    image = models.ImageField(upload_to='website/static/img/workshop/')
    category = models.CharField(max_length=255, null=True, blank=True)
    is_published = models.BooleanField(null=True, blank=True)
    order = models.IntegerField(null=True, blank=True)
    notes = models.TextField(null=True, blank=True)
...
class Instructor(models.Model):
    ...
    description = models.TextField(null=True, blank=True)
    picture = models.ImageField(upload_to='website/static/img/instructor/')
    this_workshops = models.ManyToManyField("Workshop", null=True, blank=True)
